...
- `maxJointStepDeg` — максимально допустимый скачок любого сустава между соседними проверочными точками. Если скачок больше, прямой `MoveL` считается опасным: возможны лимит, сингулярность или смена конфигурации.
